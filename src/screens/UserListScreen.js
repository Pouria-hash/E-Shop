...
import { getUserList, userDeleteAction } from '../actions/userAction'
...
const UserListScreen = (props) => {
    ...
    const { success: successDelete, loading: loadingDeleteUser, error: errorDeleteUser } = useSelector(state => state.userDelete)
    useEffect(() => {
    ...
    return loading ? <h3>Loading... </h3> : error ? <Message variant="danger">{error}</Message> : (
        <div>
